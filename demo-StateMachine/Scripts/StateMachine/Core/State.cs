...
{
	/**
	 * Contains multiple instances of Action and Transition.
	 * The State is responsible for routing the callbacks from the StateMachine to each Action and Transition.
