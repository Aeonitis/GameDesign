...
{
	/// <summary>
	/// A class that represents a conditional statement.
	/// This is the base class all custom conditions must inherit from.
	/// </summary>
	...
	/// <summary>
	/// A struct that holds a Condition and the expected result of the condition.
	/// This allows for re-usability for when a Condition should sometimes evaluate to true, and sometimes to false.
