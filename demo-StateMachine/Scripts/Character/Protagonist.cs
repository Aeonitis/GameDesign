...
public class Protagonist : MonoBehaviour
{
	...
	[HideInInspector] public bool passInput;
	...
	{
		_inputReader.passEvent += OnPassInitiated;
		_inputReader.passCancelledEvent += OnPassCancelled;
		_inputReader.jumpEvent += OnJumpInitiated;
		_inputReader.jumpCancelledEvent += OnJumpCancelled;
		_inputReader.moveEvent += OnMove;
		_inputReader.startedRunning += OnStartedRunning;
		_inputReader.stoppedRunning += OnStoppedRunning;
		//...

		// myText.text = "JUMP: " + jumpInput;
	}
	...
	private void OnPassInitiated()
	{
		Debug.Log("OnPassInitiated");
		passInput = true;
	}

	private void OnPassCancelled()
	{
		Debug.Log("OnPassCancelled");
		passInput = false;
	}
