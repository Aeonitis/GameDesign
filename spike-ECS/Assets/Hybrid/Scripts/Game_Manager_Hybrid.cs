...
public class Game_Manager_Hybrid : Manager<Game_Manager_Hybrid> {
    ...
    private void addMoreBlocks() {
        ...
        HybridBlockController [] blocks = FindObjectsOfType<HybridBlockController>();
        foreach(HybridBlockController block in blocks) {
